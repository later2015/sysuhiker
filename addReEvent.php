...
$eventId= $_GET["eventId"]; // 帖子ID
$reType=$_GET["reType"]; //回复的类型,event表示是回复活动的
...
if ($error == false) // $error==false 表示没有错误
{
            ...
            $dbutil = new dbutil();
            $orderId=$dbutil->getEventReCount($eventId)+1;
    //now()
	...
	<form method="post" action="../loginCheck.php">
		...
		<input id="remember0" name="remember0" value="1" tabindex="7" type="checkbox">
		<a class="help-inlin">记住我</a>
